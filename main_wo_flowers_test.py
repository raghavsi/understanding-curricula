...
def main():
    ...
    tr_set = datasets.Flowers102(
        root='./data', split='test', download=False, transform=transform_train, sort_on =None)
    
    val_set = datasets.Flowers102(
        root='./data', split='val', download=False, transform=transform_test)
